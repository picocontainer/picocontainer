 ...
 * {@link com.picocontainer.behaviors.Caching.Cached} that uses a {@link ThreadLocalReference} to cache the component.
 * </p>
 * <p>
...
public final class ThreadLocalizing extends AbstractBehavior {
    ...
    /**
     * A {@link com.picocontainer.ComponentAdapter} that realizes a {@link ThreadLocal} component instance.
     * <p>
     ...
     * accessed from different threads. See {@link com.picocontainer.gems.adapters.ThreadLocalizing} for details.
     * </p>
     * <p>
    ...
    public static final class ThreadLocalized<T> extends AbstractChangedBehavior<T> {
         ...
         *
         * @param delegate The {@link com.picocontainer.ComponentAdapter} to delegate.
         * @param proxyFactory The {@link com.thoughtworks.proxy.ProxyFactory} to use.
         * @throws com.picocontainer.PicoCompositionException Thrown if the component does not implement any interface.
         */
