...
public class Assimilating extends AbstractBehavior {
     ...
     * <p>
     * Allows the instance of another {@link com.picocontainer.ComponentAdapter} to be converted into interface <code>type</code>, that the
    ...
    public static final class Assimilated<T> extends AbstractChangedBehavior<T> {
         ...
         * @throws com.picocontainer.PicoCompositionException Thrown if the <code>type</code> is not compatible and cannot be proxied.
         */
         ...
         *
         * @see com.picocontainer.behaviors.AbstractBehavior.AbstractChangedBehavior#getComponentInstance(com.picocontainer.PicoContainer, Type into)
         */
        @Override
         ...
         * type is returned.
         *
         * @see com.picocontainer.behaviors.AbstractBehavior.AbstractChangedBehavior#getComponentImplementation()
         */
        @Override
         ...
         *
         * @see com.picocontainer.behaviors.AbstractBehavior.AbstractChangedBehavior#getComponentKey()
         */
        @Override
