package com.picocontainer.modules.monitor.commonslogging;
...
public class CommonsLoggingModuleMonitorTestCase {
	...
	public void testAllMethodsCanAcceptNullParametersWithoutCrashing() {
		...
		monitor.multiModuleUndeploymentSuccess(0);
		monitor.multiModuleUndeploymentBeginning(null);
		monitor.multiModuleUndeploymentFailure(null, 0);
	}
