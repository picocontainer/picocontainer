...
import static com.picocontainer.web.remoting.JsonPicoWebRemotingServlet.makeJsonDriver;
...
public final class PicoWebRemotingTestCase {
    ...
    public void testRightParamWillCauseInvocationForCaseInsensitive() throws Exception {
        PicoWebRemoting pwr = new PicoWebRemoting(xStream, "com/picocontainer/web/remoting/", null, "y", true, true);
        pwr.setMonitor(new NullPicoWebRemotingMonitor());
    ...
    public void testCollectionAndListResults() throws Exception {
        PicoWebRemoting pwr = new PicoWebRemoting(new XStream(makeJsonDriver(JsonWriter.DROP_ROOT_MODE)), "com/picocontainer/web/remoting/", null, "y", true, true);
        pwr.setMonitor(new NullPicoWebRemotingMonitor());
