...
import static com.picocontainer.logging.loggers.ConsoleLogger.LEVEL_DEBUG;
import static com.picocontainer.logging.loggers.ConsoleLogger.LEVEL_NONE;
import static com.picocontainer.logging.store.Configurator.JDK;
import static com.picocontainer.logging.store.Configurator.LOG4J_DOM;
import static com.picocontainer.logging.store.Configurator.LOG4J_PROPERTY;
import static com.picocontainer.logging.store.Configurator.createLoggerStore;
...
public class ConfiguratorTest extends AbstractTest {
    ...
    private static final String LOGGING_PROPERTIES = "com/picocontainer/logging/store/logging.properties";
    private static final String JDK_FILENAME = "jdk";
    private static final String LOG4J_PROPERTIES_FILENAME = "log4j-properties";
    private static final String LOG4J_PROPERTIES = "com/picocontainer/logging/store/log4j.properties";
    private static final String LOG4J_XML_FILENAME = "log4j-xml";
    private static final String LOG4J_XML = "com/picocontainer/logging/store/log4j.xml";
