...
/**
 * {@link com.picocontainer.ComponentFactory} that instantiates {@link JMXExposed} instances.
...
public class JMXExposing extends AbstractBehavior {
     ...
     * {@link JMXExposed}.
     * @see com.picocontainer.ComponentFactory#createComponentAdapter(ComponentMonitor,LifecycleStrategy,Properties,Object,Class,ConstructorParameters, FieldParameters[], MethodParameters[])
     */
    @Override
    ...
    /**
     * {@link com.picocontainer.ComponentAdapter} that is exposing a component as MBean in a MBeanServer.
     * @author J&ouml;rg Schaible
     */
    @SuppressWarnings("serial")
    public static class JMXExposed<T> extends AbstractChangedBehavior<T> {
         ...
         * @param delegate The delegated {@link com.picocontainer.ComponentAdapter}.
         * @param mBeanServer The {@link javax.management.MBeanServer} used for registering the MBean.
         * @param providers An array with providers for converting the component instance into a
         *            {@link javax.management.DynamicMBean}.
         * @throws NullPointerException Thrown if the {@link javax.management.MBeanServer} or the array with the {@link com.picocontainer.gems.jmx.DynamicMBeanProvider}
         *             instances is null.
         */
        public JMXExposed(
        ...
        /**
         * Construct a JMXExposed behaviour. This instance uses a {@link com.picocontainer.gems.jmx.DynamicMBeanComponentProvider} as default to
         ...
         * <p>
         * Note, that you will have to wrap this {@link com.picocontainer.ComponentAdapter} with a {@link com.picocontainer.behaviors.Caching.Cached} to avoid
         * the registration of the same component again.
         * </p>
         * @throws com.picocontainer.PicoCompositionException Thrown by the delegate or if the registering of the
         *             {@link javax.management.DynamicMBean} in the {@link javax.management.MBeanServer } fails.
         * @see com.picocontainer.behaviors.AbstractBehavior.AbstractChangedBehavior#getComponentInstance(com.picocontainer.PicoContainer, Class)
         */
        @Override
