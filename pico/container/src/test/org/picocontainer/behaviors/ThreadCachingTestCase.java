...
public class ThreadCachingTestCase {
    ...
    @Test
    public void testThatTwoThreadsHaveSeparatedCacheValuesWithSetterInjection() {

        final Baz[] bazs = new Baz[4];

        DefaultPicoContainer parent = new DefaultPicoContainer(new Caching());
        final DefaultPicoContainer child = new DefaultPicoContainer(parent,new ThreadCaching().wrap(new SetterInjection()));
