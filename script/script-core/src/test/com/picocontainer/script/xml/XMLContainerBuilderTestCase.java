...
import com.picocontainer.script.testmodel.CustomerEntityImpl;
import com.picocontainer.script.testmodel.DefaultWebServerConfig;
import com.picocontainer.script.testmodel.Entity;
import com.picocontainer.script.testmodel.ListSupport;
import com.picocontainer.script.testmodel.MapSupport;
import com.picocontainer.script.testmodel.OrderEntityImpl;
import com.picocontainer.script.testmodel.WebServerConfig;
import com.picocontainer.script.testmodel.WebServerConfigComp;
...
public final class XMLContainerBuilderTestCase extends AbstractScriptedContainerBuilderTestCase {
    ...
    @Test public void testCreateSimpleContainer() {
        ...
        assertNotNull(pico.getComponent("com.picocontainer.script.testmodel.WebServer"));
    }
    ...
    @Test public void testCreateSimpleContainerWithExplicitKeysAndParameters() {
        Reader script = new StringReader("" +
                ...
                "  <component-implementation key='com.picocontainer.script.testmodel.WebServerConfig' class='com.picocontainer.script.testmodel.DefaultWebServerConfig'/>" +
                "  <component-implementation key='com.picocontainer.script.testmodel.WebServer' class='com.picocontainer.script.testmodel.WebServerImpl'>" +
                " 		<parameter key='com.picocontainer.script.testmodel.WebServerConfig'/>" +
        ...
        assertNotNull(pico.getComponent("com.picocontainer.script.testmodel.WebServerConfig"));
        assertNotNull(pico.getComponent("com.picocontainer.script.testmodel.WebServer"));
    }
    ...
    @Test public void testConstantParameterWithNoChildElementThrowsPicoContainerMarkupException() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-implementation class='com.picocontainer.script.xml.TestBeanComposer'>" +
                " 		<parameter>" +
                "		</parameter>" +
                "  </component-implementation>" +
                "</container>");
    ...
    @Test public void testShouldThrowExceptionForNonExistantCafClass() {
        Reader script = new StringReader("" +
                "<container component-adapter-factory='com.picocontainer.script.SomeInexistantFactory'>" +
                "  <component-implementation class='com.picocontainer.script.testmodel.DefaultWebServerConfig'/>" +
                "</container>");
        try {
            buildContainer(script);
            ...
            assertTrue("Message of exception does not contain missing class", expected.getMessage().indexOf("com.picocontainer.script.SomeInexistantFactory") > 0);
        }
    }
    ...
    @Test public void testComponentInstanceWithFactoryCanBeUsed() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-instance factory='com.picocontainer.script.xml.XMLContainerBuilderTestCase$TestFactory'>" +
                "    <config-or-whatever/>" +
                "  </component-instance>" +
                "</container>");
    ...
    @Test public void testComponentInstanceWithBeanFactory() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-instance factory='com.picocontainer.script.xml.BeanComponentInstanceFactory'>" +
                "	<com.picocontainer.script.xml.TestBean>" +
                "		<foo>10</foo>" +
                "		<bar>hello</bar>" +
                "	</com.picocontainer.script.xml.TestBean>" +
    ...
    @Test public void testComponentInstanceWithBeanFactoryAndInstanceThatIsDefinedInContainer() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-instance key='date' factory='com.picocontainer.script.xml.BeanComponentInstanceFactory'>" +
                "    <java.util.Date>" +
                "       <time>0</time>" +
                "    </java.util.Date>" +
                "  </component-instance>" +
    ...
    @Test public void testComponentInstanceWithClassKey() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-instance class-name-key='java.util.Map' factory='com.picocontainer.script.xml.XStreamComponentInstanceFactory'>" +
                "    <properties>" +
    ...
    @Test public void testComponentInstanceWithContainerFactoryAndKey() {
        Reader script = new StringReader("" +
                "<container component-instance-factory='com.picocontainer.script.xml.XMLContainerBuilderTestCase$ContainerTestFactory'>" +
                "  <component-instance factory='com.picocontainer.script.xml.XMLContainerBuilderTestCase$TestFactory'" +
                "						key='firstKey'>" +
                "    <config-or-whatever/>" +
                "  </component-instance>" +
    ...
    @Test public void testInstantiationOfComponentsWithParams() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-implementation class='com.picocontainer.script.testmodel.WebServerConfigComp'>" +
    ...
    @Test public void testInstantiationOfComponentsWithParameterInstancesOfSameComponentAndBeanFactory() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-implementation class='com.picocontainer.script.xml.TestBeanComposer'>" +
                " 		<parameter factory='com.picocontainer.script.xml.BeanComponentInstanceFactory'>" +
                "			<com.picocontainer.script.xml.TestBean>" +
                "				<foo>10</foo>" +
                "				<bar>hello1</bar>" +
                "			</com.picocontainer.script.xml.TestBean>" +
    ...
    @Test public void testInstantiationOfComponentsWithComponentAdapter() {
        Reader script = new StringReader("" +
                ...
                "	</com.picocontainer.script.xml.TestBean>" +
                "  </component-instance>" +
                "  <component-adapter key='beanKey' class='com.picocontainer.script.xml.TestBeanComposer'>" +
                " 		<parameter key='bean1'/>" +
                " 		<parameter key='bean2'/>" +
                "  </component-adapter>" +
                "</container>");
    ...
    @Test public void testComponentAdapterWithNoKeyUsesTypeAsKey() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-adapter class='com.picocontainer.script.xml.TestBeanComposer'/>" +
                "</container>");
        PicoContainer pico = buildContainer(script);
    ...
    @Test public void testJndiCanBeLeveragedForComponents() {
        Reader script = new StringReader("" +
                "<container caching='true'>" +
                "  <component-from-jndi class='com.picocontainer.script.testmodel.DefaultWebServerConfig' jndi-name='foo/bar'/>" +
                "</container>");
    ...
    @Test public void testAdaptersAlsoUseBehaviorFactory() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-adapter-factory class='com.picocontainer.injectors.ConstructorInjection' key='factory'/>" +
                "  <component-adapter class='com.picocontainer.script.testmodel.DefaultWebServerConfig' factory='factory'/>" +
                "</container>");
        PicoContainer pico = buildContainer(script);
    ...
    public void testNestedCAFLooksRightinXml() {
        ...
        assertEquals("<com.picocontainer.classname.DefaultClassLoadingPicoContainer>\n" +
                "  <namedChildContainers/>\n" +
                "  <delegate class='com.picocontainer.DefaultPicoContainer'>\n" +
                "    <keyToAdapterCache/>\n" +
                ...
                "    <childrenStarted/>\n" +
                "    <lifecycle class='com.picocontainer.lifecycle.StartableLifecycleStrategy'>\n" +
                "      <monitor class='com.picocontainer.monitors.NullComponentMonitor'/>\n" +
                "    </lifecycle>\n" +
                "    <componentCharacteristic class='com.picocontainer.DefaultPicoContainer$1'>\n" +
                "      <outer-class reference='../..'/>\n" +
                "      <props/>\n" +
                "    </componentCharacteristic>\n" +
                "    <monitor class='com.picocontainer.monitors.NullComponentMonitor' reference='../lifecycle/monitor'/>\n" +
                "  </delegate>\n" +
                "</com.picocontainer.classname.DefaultClassLoadingPicoContainer>", xml);
    ...
    public void testComponentCanUsePredefinedNestedCAF() {
        Reader script = new StringReader("" +
                "<container>" +
                "  <component-adapter-factory class='com.picocontainer.behaviors.ImplementationHiding' key='factory'>" +
                "    <component-adapter-factory class='"+ MyInjectionType.class.getName()+"'/>" +
                "  </component-adapter-factory>" +
                "  <component-adapter class-name-key='com.picocontainer.script.testmodel.WebServerConfig' class='com.picocontainer.script.testmodel.DefaultWebServerConfig' factory='factory'/>" +
    ...
    public void testInheritanceOfBehaviorsFromParentContainer() {
    	Reader comparison = new StringReader("" +
                ...
                "  <component class='com.picocontainer.script.testmodel.DefaultWebServerConfig'/>" +
                "</container>"
        	);
