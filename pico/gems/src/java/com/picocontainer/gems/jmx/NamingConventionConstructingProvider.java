...
public class NamingConventionConstructingProvider extends AbstractConstructingProvider {
     ...
     * @see com.picocontainer.gems.jmx.AbstractConstructingProvider#getMBeanFactory()
     */
    @Override
    ...
    /**
     * @see com.picocontainer.gems.jmx.AbstractConstructingProvider#getObjectNameFactory()
     */
    @Override
     ...
     * @see com.picocontainer.gems.jmx.AbstractConstructingProvider#getMBeanInfoProviders()
     */
    @Override
